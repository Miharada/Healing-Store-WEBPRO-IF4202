		  ...
		  <div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
			  <div class="modal-content">
				...
				<form>
      <div class="form-group">
				<input type="hidden" class="form-control" id="username_edit" placeholder="" name="username_edit" required>
			</div>
			<div class="form-group">
				<label for="formGroupExampleInput">Nama Pelanggan</label>
				<input type="text" class="form-control" id="nama_pelanggan_edit" placeholder="Nama Pelanggan" name="nama_pelanggan_edit" required>
			</div>
			<div class="form-group">
  ...
  $(document).ready(function(){
        ...
        success : function(data){
          ...
          for(i=0; i<data.length; i++){
            html+='<tr>' +
                    ...
                    '<td class="text-center">'+data[i].nama_pelanggan+'</td>'+
    ...
    $('#data_submit').on('click',function(){
      ...
      $.ajax({
        ...
        dataType : 'JSON',
        data : {nama_pelanggan:nama_pelanggan, password:password, no_hp:no_hp, email:email},
        success : function(data){
    ...
    $('#table1').on('click','.item_edit',function(){
      ...
      $('[name="nama_pelanggan_edit"]').val(nama_pelanggan);
    ...
    $('#btn_konfirmasi_edit').on('click',function(){
      ...
      $.ajax({
        ...
        dataType : 'JSON',
        data : {username:username, nama_pelanggan:nama_pelanggan, password:password, no_hp:no_hp, email:email},
        success: function(data){
